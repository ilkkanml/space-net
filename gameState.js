...
.eva-current-message {
  margin-top: 10px;
  padding: 10px;
  border-left: 3px solid rgba(110, 231, 255, 0.65);
  border-radius: 8px;
...
.build-button {
  ...
  border-radius: 10px;
  background: rgba(29, 167, 198, 0.16);
  color: #e9f6ff;
  cursor: pointer;
  text-align: left;
}
...
.build-button.active {
  background: rgba(29, 167, 198, 0.32);
...
.action-button {
  ...
  border-radius: 10px;
  background: rgba(29, 167, 198, 0.22);
  color: #e9f6ff;
  font-weight: 700;
  cursor: pointer;
}
...
.action-button:hover {
  background: rgba(29, 167, 198, 0.34);
}
...
/* Milestone 10 Hotfix — Remove Mode UI */
.build-button.danger,
.build-button.remove-build {
  border-color: rgba(255, 110, 110, 0.42);
  background: rgba(180, 40, 40, 0.22);
}

.build-button.danger:hover,
.build-button.remove-build:hover,
.build-button.remove-build.active {
...
.machine-status-pill.warning {
  background: rgba(245,158,11,0.18);
  color: #fcd34d;
}

.machine-status-pill.blocked {
...
/* Milestone 13 — Passive Progression Presentation Layer */
.progression-readout {
  margin-top: 12px;
  padding-top: 10px;
