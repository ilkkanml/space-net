...
function getGroundPosition() {
  ...
  const didIntersect = raycaster.ray.intersectPlane(groundPlane, point);
...
function tryPlaceBuildingAtPointer() {
  ...
  const placed = tryPlaceBuilding(position, getWorldObjectUnderPointer());
